...
class MQ():
    ...
    def __init__(self, Ro=3.6, analogPin=0):
        self.Ro = Ro
        self.MQ_PIN = analogPin
        self.adc = MCP3008()
        
        self.AMONIACurve = [1,0.41,-0.218]    # two points are taken from the curve. 
                                            # with these two points, a line is formed which is "approximately equivalent"
                                            # to the original curve. 
                                            # data format:{ x, y, slope}; point1: (lg10, 2.56), point2: (lg199.69, 0.76) 
    ...
    def MQPercentage(self):
        ...
        val["GAS_AMONIA"]  = self.MQGetGasPercentage(read/self.Ro, self.GAS_AMONIA)
        return val
    ...
    def MQGetGasPercentage(self, rs_ro_ratio, gas_id):
        if ( gas_id == self.GAS_AMONIA ):
            return self.MQGetPercentage(rs_ro_ratio, self.AMONIACurve)
        return 0
